...
for k=1:N
    ...
    Cbn=Cnb';
    hmag=Cbn*[mx my mz]';
    temp_hmag=Cbn'*[sqrt(hmag(1)^2+hmag(2)^2) 0 hmag(3)]';
    theta = atan2(hmag(3),sqrt(hmag(1)^2+hmag(2)^2));
    MD_sin=sin(theta);
    MD_cos=cos(theta);
    
    Hk2 = zeros(3,4);
    Hk2(1,1) = 2*MD_cos*q0 - 2*MD_sin*q2;
    Hk2(1,2) = 2*MD_cos*q1 + 2*MD_sin*q3;
    Hk2(1,3) = - 2*MD_cos*q2 - 2*MD_sin*q0;
    Hk2(1,4) = 2*MD_sin*q1 - 2*MD_cos*q3;
    Hk2(2,1) = 2*MD_sin*q1 - 2*MD_cos*q3;
    Hk2(2,2) = 2*MD_cos*q2 + 2*MD_sin*q0;
    Hk2(2,3) = 2*MD_cos*q1 + 2*MD_sin*q3;
    Hk2(2,4) = 2*MD_sin*q2 - 2*MD_cos*q0;
    Hk2(3,1) = 2*MD_cos*q2 + 2*MD_sin*q0;
    Hk2(3,2) = 2*MD_cos*q3 - 2*MD_sin*q1;
    Hk2(3,3) = 2*MD_cos*q0 - 2*MD_sin*q2;
    Hk2(3,4) = 2*MD_cos*q1 + 2*MD_sin*q3;
    SK_MagX = zeros(5,1);
    SK_MagX(1) = 1/(R_Mag + (2*MD_cos*q0 - 2*MD_sin*q2)*(Pk_k1(1,1)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(2,1)*(2*MD_cos*q1 + 2*MD_sin*q3) - Pk_k1(3,1)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(4,1)*(2*MD_cos*q3 - 2*MD_sin*q1)) + (2*MD_cos*q1 + 2*MD_sin*q3)*(Pk_k1(1,2)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(2,2)*(2*MD_cos*q1 + 2*MD_sin*q3) - Pk_k1(3,2)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(4,2)*(2*MD_cos*q3 - 2*MD_sin*q1)) - (2*MD_cos*q2 + 2*MD_sin*q0)*(Pk_k1(1,3)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(2,3)*(2*MD_cos*q1 + 2*MD_sin*q3) - Pk_k1(3,3)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(4,3)*(2*MD_cos*q3 - 2*MD_sin*q1)) - (2*MD_cos*q3 - 2*MD_sin*q1)*(Pk_k1(1,4)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(2,4)*(2*MD_cos*q1 + 2*MD_sin*q3) - Pk_k1(3,4)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(4,4)*(2*MD_cos*q3 - 2*MD_sin*q1)));
    SK_MagX(2) = 2*MD_cos*q0 - 2*MD_sin*q2;
    SK_MagX(3) = 2*MD_cos*q3 - 2*MD_sin*q1;
    SK_MagX(4) = 2*MD_cos*q1 + 2*MD_sin*q3;
    SK_MagX(5) = 2*MD_cos*q2 + 2*MD_sin*q0;
    SK_MagY = zeros(5,1);
    SK_MagY(1) = 1/(R_Mag + (2*MD_cos*q3 - 2*MD_sin*q1)*(Pk_k1(1,1)*(2*MD_cos*q3 - 2*MD_sin*q1) - Pk_k1(2,1)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(3,1)*(2*MD_cos*q1 + 2*MD_sin*q3) + Pk_k1(4,1)*(2*MD_cos*q0 - 2*MD_sin*q2)) - (2*MD_cos*q2 + 2*MD_sin*q0)*(Pk_k1(1,2)*(2*MD_cos*q3 - 2*MD_sin*q1) - Pk_k1(2,2)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(3,2)*(2*MD_cos*q1 + 2*MD_sin*q3) + Pk_k1(4,2)*(2*MD_cos*q0 - 2*MD_sin*q2)) - (2*MD_cos*q1 + 2*MD_sin*q3)*(Pk_k1(1,3)*(2*MD_cos*q3 - 2*MD_sin*q1) - Pk_k1(2,3)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(3,3)*(2*MD_cos*q1 + 2*MD_sin*q3) + Pk_k1(4,3)*(2*MD_cos*q0 - 2*MD_sin*q2)) + (2*MD_cos*q0 - 2*MD_sin*q2)*(Pk_k1(1,4)*(2*MD_cos*q3 - 2*MD_sin*q1) - Pk_k1(2,4)*(2*MD_cos*q2 + 2*MD_sin*q0) - Pk_k1(3,4)*(2*MD_cos*q1 + 2*MD_sin*q3) + Pk_k1(4,4)*(2*MD_cos*q0 - 2*MD_sin*q2)));
    SK_MagY(2) = 2*MD_cos*q1 + 2*MD_sin*q3;
    SK_MagY(3) = 2*MD_cos*q0 - 2*MD_sin*q2;
    SK_MagY(4) = 2*MD_cos*q3 - 2*MD_sin*q1;
    SK_MagY(5) = 2*MD_cos*q2 + 2*MD_sin*q0;
    SK_MagZ = zeros(5,1);
    SK_MagZ(1) = 1/(R_Mag + (2*MD_cos*q2 + 2*MD_sin*q0)*(Pk_k1(1,1)*(2*MD_cos*q2 + 2*MD_sin*q0) + Pk_k1(2,1)*(2*MD_cos*q3 - 2*MD_sin*q1) + Pk_k1(3,1)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(4,1)*(2*MD_cos*q1 + 2*MD_sin*q3)) + (2*MD_cos*q3 - 2*MD_sin*q1)*(Pk_k1(1,2)*(2*MD_cos*q2 + 2*MD_sin*q0) + Pk_k1(2,2)*(2*MD_cos*q3 - 2*MD_sin*q1) + Pk_k1(3,2)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(4,2)*(2*MD_cos*q1 + 2*MD_sin*q3)) + (2*MD_cos*q0 - 2*MD_sin*q2)*(Pk_k1(1,3)*(2*MD_cos*q2 + 2*MD_sin*q0) + Pk_k1(2,3)*(2*MD_cos*q3 - 2*MD_sin*q1) + Pk_k1(3,3)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(4,3)*(2*MD_cos*q1 + 2*MD_sin*q3)) + (2*MD_cos*q1 + 2*MD_sin*q3)*(Pk_k1(1,4)*(2*MD_cos*q2 + 2*MD_sin*q0) + Pk_k1(2,4)*(2*MD_cos*q3 - 2*MD_sin*q1) + Pk_k1(3,4)*(2*MD_cos*q0 - 2*MD_sin*q2) + Pk_k1(4,4)*(2*MD_cos*q1 + 2*MD_sin*q3)));
    SK_MagZ(2) = 2*MD_cos*q3 - 2*MD_sin*q1;
    SK_MagZ(3) = 2*MD_cos*q0 - 2*MD_sin*q2;
    SK_MagZ(4) = 2*MD_cos*q1 + 2*MD_sin*q3;
    SK_MagZ(5) = 2*MD_cos*q2 + 2*MD_sin*q0;
    Kk2 = zeros(4,3);
    Kk2(1,1) = SK_MagX(1)*(Pk_k1(1,1)*SK_MagX(2) + Pk_k1(1,2)*SK_MagX(4) - Pk_k1(1,4)*SK_MagX(3) - Pk_k1(1,3)*SK_MagX(5));
    Kk2(1,2) = -SK_MagY(1)*(Pk_k1(1,1)*SK_MagY(4) - Pk_k1(1,3)*SK_MagY(2) - Pk_k1(1,2)*SK_MagY(5) + Pk_k1(1,4)*SK_MagY(3));
    Kk2(1,3) = SK_MagZ(1)*(Pk_k1(1,2)*SK_MagZ(2) + Pk_k1(1,1)*SK_MagZ(5) + Pk_k1(1,3)*SK_MagZ(3) + Pk_k1(1,4)*SK_MagZ(4));
    Kk2(2,1) = SK_MagX(1)*(Pk_k1(2,1)*SK_MagX(2) + Pk_k1(2,2)*SK_MagX(4) - Pk_k1(2,4)*SK_MagX(3) - Pk_k1(2,3)*SK_MagX(5));
    Kk2(2,2) = -SK_MagY(1)*(Pk_k1(2,1)*SK_MagY(4) - Pk_k1(2,3)*SK_MagY(2) - Pk_k1(2,2)*SK_MagY(5) + Pk_k1(2,4)*SK_MagY(3));
    Kk2(2,3) = SK_MagZ(1)*(Pk_k1(2,2)*SK_MagZ(2) + Pk_k1(2,1)*SK_MagZ(5) + Pk_k1(2,3)*SK_MagZ(3) + Pk_k1(2,4)*SK_MagZ(4));
    Kk2(3,1) = SK_MagX(1)*(Pk_k1(3,1)*SK_MagX(2) + Pk_k1(3,2)*SK_MagX(4) - Pk_k1(3,4)*SK_MagX(3) - Pk_k1(3,3)*SK_MagX(5));
    Kk2(3,2) = -SK_MagY(1)*(Pk_k1(3,1)*SK_MagY(4) - Pk_k1(3,3)*SK_MagY(2) - Pk_k1(3,2)*SK_MagY(5) + Pk_k1(3,4)*SK_MagY(3));
    Kk2(3,3) = SK_MagZ(1)*(Pk_k1(3,2)*SK_MagZ(2) + Pk_k1(3,1)*SK_MagZ(5) + Pk_k1(3,3)*SK_MagZ(3) + Pk_k1(3,4)*SK_MagZ(4));
    Kk2(4,1) = SK_MagX(1)*(Pk_k1(4,1)*SK_MagX(2) + Pk_k1(4,2)*SK_MagX(4) - Pk_k1(4,4)*SK_MagX(3) - Pk_k1(4,3)*SK_MagX(5));
    Kk2(4,2) = -SK_MagY(1)*(Pk_k1(4,1)*SK_MagY(4) - Pk_k1(4,3)*SK_MagY(2) - Pk_k1(4,2)*SK_MagY(5) + Pk_k1(4,4)*SK_MagY(3));
    Kk2(4,3) = SK_MagZ(1)*(Pk_k1(4,2)*SK_MagZ(2) + Pk_k1(4,1)*SK_MagZ(5) + Pk_k1(4,3)*SK_MagZ(3) + Pk_k1(4,4)*SK_MagZ(4));
    hk2 = zeros(3,1);
    hk2(1) = MD_cos*(q0^2 + q1^2 - q2^2 - q3^2) - MD_sin*(2*q0*q2 - 2*q1*q3);
    hk2(2) = MD_sin*(2*q0*q1 + 2*q2*q3) - MD_cos*(2*q0*q3 - 2*q1*q2);
    hk2(3) = MD_sin*(q0^2 - q1^2 - q2^2 + q3^2) + MD_cos*(2*q0*q2 + 2*q1*q3);
