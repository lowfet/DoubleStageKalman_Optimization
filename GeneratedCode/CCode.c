...
Hk1[2][3] = 2*q3;
float SK_dVelX[1][1];
SK_dVelX[0] = 1/(R_dVel + 2*q2*(2*Pk_k1[0][0]*q2 - 2*Pk_k1[1][0]*q3 + 2*Pk_k1[2][0]*q0 - 2*Pk_k1[3][0]*q1) - 2*q3*(2*Pk_k1[0][1]*q2 - 2*Pk_k1[1][1]*q3 + 2*Pk_k1[2][1]*q0 - 2*Pk_k1[3][1]*q1) + 2*q0*(2*Pk_k1[0][2]*q2 - 2*Pk_k1[1][2]*q3 + 2*Pk_k1[2][2]*q0 - 2*Pk_k1[3][2]*q1) - 2*q1*(2*Pk_k1[0][3]*q2 - 2*Pk_k1[1][3]*q3 + 2*Pk_k1[2][3]*q0 - 2*Pk_k1[3][3]*q1));
float SK_dVelY[1][1];
SK_dVelY[0] = 1/(R_dVel + 2*q1*(2*Pk_k1[0][0]*q1 + 2*Pk_k1[1][0]*q0 + 2*Pk_k1[2][0]*q3 + 2*Pk_k1[3][0]*q2) + 2*q0*(2*Pk_k1[0][1]*q1 + 2*Pk_k1[1][1]*q0 + 2*Pk_k1[2][1]*q3 + 2*Pk_k1[3][1]*q2) + 2*q3*(2*Pk_k1[0][2]*q1 + 2*Pk_k1[1][2]*q0 + 2*Pk_k1[2][2]*q3 + 2*Pk_k1[3][2]*q2) + 2*q2*(2*Pk_k1[0][3]*q1 + 2*Pk_k1[1][3]*q0 + 2*Pk_k1[2][3]*q3 + 2*Pk_k1[3][3]*q2));
float SK_dVelZ[1][1];
SK_dVelZ[0] = 1/(R_dVel + 2*q0*(2*Pk_k1[0][0]*q0 - 2*Pk_k1[1][0]*q1 - 2*Pk_k1[2][0]*q2 + 2*Pk_k1[3][0]*q3) - 2*q1*(2*Pk_k1[0][1]*q0 - 2*Pk_k1[1][1]*q1 - 2*Pk_k1[2][1]*q2 + 2*Pk_k1[3][1]*q3) - 2*q2*(2*Pk_k1[0][2]*q0 - 2*Pk_k1[1][2]*q1 - 2*Pk_k1[2][2]*q2 + 2*Pk_k1[3][2]*q3) + 2*q3*(2*Pk_k1[0][3]*q0 - 2*Pk_k1[1][3]*q1 - 2*Pk_k1[2][3]*q2 + 2*Pk_k1[3][3]*q3));
float Kk1[4][3];
Kk1[0][0] = -SK_dVelX[0]*(2*Pk_k1[0][0]*q2 + 2*Pk_k1[0][2]*q0 - 2*Pk_k1[0][1]*q3 - 2*Pk_k1[0][3]*q1);
Kk1[0][1] = SK_dVelY[0]*(2*Pk_k1[0][0]*q1 + 2*Pk_k1[0][1]*q0 + 2*Pk_k1[0][2]*q3 + 2*Pk_k1[0][3]*q2);
Kk1[0][2] = SK_dVelZ[0]*(2*Pk_k1[0][0]*q0 - 2*Pk_k1[0][1]*q1 - 2*Pk_k1[0][2]*q2 + 2*Pk_k1[0][3]*q3);
Kk1[1][0] = -SK_dVelX[0]*(2*Pk_k1[1][0]*q2 + 2*Pk_k1[1][2]*q0 - 2*Pk_k1[1][1]*q3 - 2*Pk_k1[1][3]*q1);
Kk1[1][1] = SK_dVelY[0]*(2*Pk_k1[1][0]*q1 + 2*Pk_k1[1][1]*q0 + 2*Pk_k1[1][2]*q3 + 2*Pk_k1[1][3]*q2);
Kk1[1][2] = SK_dVelZ[0]*(2*Pk_k1[1][0]*q0 - 2*Pk_k1[1][1]*q1 - 2*Pk_k1[1][2]*q2 + 2*Pk_k1[1][3]*q3);
Kk1[2][0] = -SK_dVelX[0]*(2*Pk_k1[2][0]*q2 + 2*Pk_k1[2][2]*q0 - 2*Pk_k1[2][1]*q3 - 2*Pk_k1[2][3]*q1);
Kk1[2][1] = SK_dVelY[0]*(2*Pk_k1[2][0]*q1 + 2*Pk_k1[2][1]*q0 + 2*Pk_k1[2][2]*q3 + 2*Pk_k1[2][3]*q2);
Kk1[2][2] = SK_dVelZ[0]*(2*Pk_k1[2][0]*q0 - 2*Pk_k1[2][1]*q1 - 2*Pk_k1[2][2]*q2 + 2*Pk_k1[2][3]*q3);
Kk1[3][0] = -SK_dVelX[0]*(2*Pk_k1[3][0]*q2 + 2*Pk_k1[3][2]*q0 - 2*Pk_k1[3][1]*q3 - 2*Pk_k1[3][3]*q1);
Kk1[3][1] = SK_dVelY[0]*(2*Pk_k1[3][0]*q1 + 2*Pk_k1[3][1]*q0 + 2*Pk_k1[3][2]*q3 + 2*Pk_k1[3][3]*q2);
Kk1[3][2] = SK_dVelZ[0]*(2*Pk_k1[3][0]*q0 - 2*Pk_k1[3][1]*q1 - 2*Pk_k1[3][2]*q2 + 2*Pk_k1[3][3]*q3);
float hk1[3][1];
hk1[0] = 2*q1*q3 - 2*q0*q2;
hk1[1] = 2*q0*q1 + 2*q2*q3;
hk1[2] = q0*q0 - q1*q1 - q2*q2 + q3*q3;
float Sqc1[3][1];
Sqc1[0] = dvz - hk1[2][0];
Sqc1[1] = dvy - hk1[1][0];
Sqc1[2] = dvx - hk1[0][0];
...
float hmag[3][1];
hmag[0] = magX*(q0*q0 + q1*q1 - q2*q2 - q3*q3) - magY*(2*q0*q3 - 2*q1*q2) + magZ*(2*q0*q2 + 2*q1*q3);
hmag[1] = magY*(q0*q0 - q1*q1 + q2*q2 - q3*q3) + magX*(2*q0*q3 + 2*q1*q2) - magZ*(2*q0*q1 - 2*q2*q3);
hmag[2] = magZ*(q0*q0 - q1*q1 - q2*q2 + q3*q3) - magX*(2*q0*q2 - 2*q1*q3) + magY*(2*q0*q1 + 2*q2*q3);
float MI[1][1];
MI[0] = atan2(hmagZ][ (sqrt(hmagX*hmagX + hmagY*hmagY)));
float Hk2[3][4];
Hk2[0][0] = 2*MI_cos*q0 - 2*MI_sin*q2;
Hk2[0][1] = 2*MI_cos*q1 + 2*MI_sin*q3;
Hk2[0][2] = - 2*MI_cos*q2 - 2*MI_sin*q0;
Hk2[0][3] = 2*MI_sin*q1 - 2*MI_cos*q3;
Hk2[1][0] = 2*MI_sin*q1 - 2*MI_cos*q3;
Hk2[1][1] = 2*MI_cos*q2 + 2*MI_sin*q0;
Hk2[1][2] = 2*MI_cos*q1 + 2*MI_sin*q3;
Hk2[1][3] = 2*MI_sin*q2 - 2*MI_cos*q0;
Hk2[2][0] = 2*MI_cos*q2 + 2*MI_sin*q0;
Hk2[2][1] = 2*MI_cos*q3 - 2*MI_sin*q1;
Hk2[2][2] = 2*MI_cos*q0 - 2*MI_sin*q2;
Hk2[2][3] = 2*MI_cos*q1 + 2*MI_sin*q3;
float SK_MagX[5][1];
SK_MagX[0] = 1/(R_Mag + (2*MI_cos*q0 - 2*MI_sin*q2)*(Pk_k1[0][0]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[1][0]*(2*MI_cos*q1 + 2*MI_sin*q3) - Pk_k1[2][0]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[3][0]*(2*MI_cos*q3 - 2*MI_sin*q1)) + (2*MI_cos*q1 + 2*MI_sin*q3)*(Pk_k1[0][1]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[1][1]*(2*MI_cos*q1 + 2*MI_sin*q3) - Pk_k1[2][1]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[3][1]*(2*MI_cos*q3 - 2*MI_sin*q1)) - (2*MI_cos*q2 + 2*MI_sin*q0)*(Pk_k1[0][2]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[1][2]*(2*MI_cos*q1 + 2*MI_sin*q3) - Pk_k1[2][2]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[3][2]*(2*MI_cos*q3 - 2*MI_sin*q1)) - (2*MI_cos*q3 - 2*MI_sin*q1)*(Pk_k1[0][3]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[1][3]*(2*MI_cos*q1 + 2*MI_sin*q3) - Pk_k1[2][3]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[3][3]*(2*MI_cos*q3 - 2*MI_sin*q1)));
SK_MagX[1] = 2*MI_cos*q0 - 2*MI_sin*q2;
SK_MagX[2] = 2*MI_cos*q3 - 2*MI_sin*q1;
SK_MagX[3] = 2*MI_cos*q1 + 2*MI_sin*q3;
SK_MagX[4] = 2*MI_cos*q2 + 2*MI_sin*q0;
float SK_MagY[5][1];
SK_MagY[0] = 1/(R_Mag + (2*MI_cos*q3 - 2*MI_sin*q1)*(Pk_k1[0][0]*(2*MI_cos*q3 - 2*MI_sin*q1) - Pk_k1[1][0]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[2][0]*(2*MI_cos*q1 + 2*MI_sin*q3) + Pk_k1[3][0]*(2*MI_cos*q0 - 2*MI_sin*q2)) - (2*MI_cos*q2 + 2*MI_sin*q0)*(Pk_k1[0][1]*(2*MI_cos*q3 - 2*MI_sin*q1) - Pk_k1[1][1]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[2][1]*(2*MI_cos*q1 + 2*MI_sin*q3) + Pk_k1[3][1]*(2*MI_cos*q0 - 2*MI_sin*q2)) - (2*MI_cos*q1 + 2*MI_sin*q3)*(Pk_k1[0][2]*(2*MI_cos*q3 - 2*MI_sin*q1) - Pk_k1[1][2]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[2][2]*(2*MI_cos*q1 + 2*MI_sin*q3) + Pk_k1[3][2]*(2*MI_cos*q0 - 2*MI_sin*q2)) + (2*MI_cos*q0 - 2*MI_sin*q2)*(Pk_k1[0][3]*(2*MI_cos*q3 - 2*MI_sin*q1) - Pk_k1[1][3]*(2*MI_cos*q2 + 2*MI_sin*q0) - Pk_k1[2][3]*(2*MI_cos*q1 + 2*MI_sin*q3) + Pk_k1[3][3]*(2*MI_cos*q0 - 2*MI_sin*q2)));
SK_MagY[1] = 2*MI_cos*q1 + 2*MI_sin*q3;
SK_MagY[2] = 2*MI_cos*q0 - 2*MI_sin*q2;
SK_MagY[3] = 2*MI_cos*q3 - 2*MI_sin*q1;
SK_MagY[4] = 2*MI_cos*q2 + 2*MI_sin*q0;
float SK_MagZ[5][1];
SK_MagZ[0] = 1/(R_Mag + (2*MI_cos*q2 + 2*MI_sin*q0)*(Pk_k1[0][0]*(2*MI_cos*q2 + 2*MI_sin*q0) + Pk_k1[1][0]*(2*MI_cos*q3 - 2*MI_sin*q1) + Pk_k1[2][0]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[3][0]*(2*MI_cos*q1 + 2*MI_sin*q3)) + (2*MI_cos*q3 - 2*MI_sin*q1)*(Pk_k1[0][1]*(2*MI_cos*q2 + 2*MI_sin*q0) + Pk_k1[1][1]*(2*MI_cos*q3 - 2*MI_sin*q1) + Pk_k1[2][1]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[3][1]*(2*MI_cos*q1 + 2*MI_sin*q3)) + (2*MI_cos*q0 - 2*MI_sin*q2)*(Pk_k1[0][2]*(2*MI_cos*q2 + 2*MI_sin*q0) + Pk_k1[1][2]*(2*MI_cos*q3 - 2*MI_sin*q1) + Pk_k1[2][2]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[3][2]*(2*MI_cos*q1 + 2*MI_sin*q3)) + (2*MI_cos*q1 + 2*MI_sin*q3)*(Pk_k1[0][3]*(2*MI_cos*q2 + 2*MI_sin*q0) + Pk_k1[1][3]*(2*MI_cos*q3 - 2*MI_sin*q1) + Pk_k1[2][3]*(2*MI_cos*q0 - 2*MI_sin*q2) + Pk_k1[3][3]*(2*MI_cos*q1 + 2*MI_sin*q3)));
SK_MagZ[1] = 2*MI_cos*q3 - 2*MI_sin*q1;
SK_MagZ[2] = 2*MI_cos*q0 - 2*MI_sin*q2;
SK_MagZ[3] = 2*MI_cos*q1 + 2*MI_sin*q3;
SK_MagZ[4] = 2*MI_cos*q2 + 2*MI_sin*q0;
float Kk2[4][3];
Kk2[0][0] = SK_MagX[0]*(Pk_k1[0][0]*SK_MagX[1] + Pk_k1[0][1]*SK_MagX[3] - Pk_k1[0][3]*SK_MagX[2] - Pk_k1[0][2]*SK_MagX[4]);
Kk2[0][1] = -SK_MagY[0]*(Pk_k1[0][0]*SK_MagY[3] - Pk_k1[0][2]*SK_MagY[1] - Pk_k1[0][1]*SK_MagY[4] + Pk_k1[0][3]*SK_MagY[2]);
Kk2[0][2] = SK_MagZ[0]*(Pk_k1[0][1]*SK_MagZ[1] + Pk_k1[0][0]*SK_MagZ[4] + Pk_k1[0][2]*SK_MagZ[2] + Pk_k1[0][3]*SK_MagZ[3]);
Kk2[1][0] = SK_MagX[0]*(Pk_k1[1][0]*SK_MagX[1] + Pk_k1[1][1]*SK_MagX[3] - Pk_k1[1][3]*SK_MagX[2] - Pk_k1[1][2]*SK_MagX[4]);
Kk2[1][1] = -SK_MagY[0]*(Pk_k1[1][0]*SK_MagY[3] - Pk_k1[1][2]*SK_MagY[1] - Pk_k1[1][1]*SK_MagY[4] + Pk_k1[1][3]*SK_MagY[2]);
Kk2[1][2] = SK_MagZ[0]*(Pk_k1[1][1]*SK_MagZ[1] + Pk_k1[1][0]*SK_MagZ[4] + Pk_k1[1][2]*SK_MagZ[2] + Pk_k1[1][3]*SK_MagZ[3]);
Kk2[2][0] = SK_MagX[0]*(Pk_k1[2][0]*SK_MagX[1] + Pk_k1[2][1]*SK_MagX[3] - Pk_k1[2][3]*SK_MagX[2] - Pk_k1[2][2]*SK_MagX[4]);
Kk2[2][1] = -SK_MagY[0]*(Pk_k1[2][0]*SK_MagY[3] - Pk_k1[2][2]*SK_MagY[1] - Pk_k1[2][1]*SK_MagY[4] + Pk_k1[2][3]*SK_MagY[2]);
Kk2[2][2] = SK_MagZ[0]*(Pk_k1[2][1]*SK_MagZ[1] + Pk_k1[2][0]*SK_MagZ[4] + Pk_k1[2][2]*SK_MagZ[2] + Pk_k1[2][3]*SK_MagZ[3]);
Kk2[3][0] = SK_MagX[0]*(Pk_k1[3][0]*SK_MagX[1] + Pk_k1[3][1]*SK_MagX[3] - Pk_k1[3][3]*SK_MagX[2] - Pk_k1[3][2]*SK_MagX[4]);
Kk2[3][1] = -SK_MagY[0]*(Pk_k1[3][0]*SK_MagY[3] - Pk_k1[3][2]*SK_MagY[1] - Pk_k1[3][1]*SK_MagY[4] + Pk_k1[3][3]*SK_MagY[2]);
Kk2[3][2] = SK_MagZ[0]*(Pk_k1[3][1]*SK_MagZ[1] + Pk_k1[3][0]*SK_MagZ[4] + Pk_k1[3][2]*SK_MagZ[2] + Pk_k1[3][3]*SK_MagZ[3]);
float hk2[3][1];
hk2[0] = MI_cos*(q0*q0 + q1*q1 - q2*q2 - q3*q3) - MI_sin*(2*q0*q2 - 2*q1*q3);
hk2[1] = MI_sin*(2*q0*q1 + 2*q2*q3) - MI_cos*(2*q0*q3 - 2*q1*q2);
hk2[2] = MI_sin*(q0*q0 - q1*q1 - q2*q2 + q3*q3) + MI_cos*(2*q0*q2 + 2*q1*q3);
float Sqc2[3][1];
Sqc2[0] = hk2[2][0] - magZ;
Sqc2[1] = hk2[1][0] - magY;
Sqc2[2] = hk2[0][0] - magX;
